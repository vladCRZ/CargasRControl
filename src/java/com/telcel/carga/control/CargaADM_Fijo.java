...
public class CargaADM_Fijo
{
  ...
  public static void main(String[] args)
  {
    ...
    for (OrdenTrabajoVO ordenTrabajoVO : voOrdenesT)
    {
      ...
      //En lugar del archivo descargado se usa un reemplazo corregido para acelerar la ejecucion
      //Verificar en el archivo properties la propiedad reemplazo
      nombreArchivo = prop.getProperty("RUTA_ADM")+prop.getProperty("REEMPLAZO");
