...
public class CambioADM
{
  ...
  public static void main(String[] args)
  {
    ...
    List<OrdenTrabajoVO> voOrdenesT = voRemedyControl.fncConsultaOrdenesT("CAMBIO");
    ...
    for (OrdenTrabajoVO ordenTrabajoVO : voOrdenesT)
    {
      ...
      //Excepcion para incluir nombre de formato alterno
      String nombreArchivo = "";
      nombreArchivo = voRemedyControl.fncRecuperarNombreArchivo(ordenTrabajoVO.getViIDRequerimiento());
      if(nombreArchivo.equals("Formato+Alta+de+Perfiles+ADM.xlsx"))
          voAdm = voLectura.fncLeerArchivoAdm("/home/remedy/download/RM/Formato+Alta+de+Perfiles+ADM.xlsx");
      else
          voAdm = voLectura.fncLeerArchivoAdm(prop.getProperty("PATH_ADM"));
